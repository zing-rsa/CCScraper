...
export class CnftService {
    ...
    private buildBody(options) {
        ...
        return { 
            ...
            "project": "CardanoCity", 
            "sort": sort, 
            "priceMin": (options.priceMin != null && options.priceMin != '' ? (options.priceMin * 1000000) : 0), 
            "priceMax": (options.priceMax != null && options.priceMax != '' ? options.priceMax * 1000000 : null), 
            "page": options.page, 
            "verified": true, 
            "nsfw": false, 
            "sold": false 
